        ...
        <section className="space-y-6 animate-fade-in-up-delayed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {projects.map((project) => (
              <div
                key={project.id}
                className="card card--section card--interactive p-6 group"
              >
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-semibold text-lg text-primary group-hover:text-[color:var(--color-primary)] transition-colors">
                      {project.title}
                    </h3>
                  </div>
                </div>
